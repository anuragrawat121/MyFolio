...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ra,depthTest:!1,depthWrite:!1})}function vw(r,e,i){const s=new Float32Array(Wr),l=new Q(0,1,0);return new ea({name:"SphericalGaussianBlur",defines:{n:Wr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:s},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:Uu(),fragmentShader:`
	...
	`}class tS extends Qi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new Zx(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new ro(5,5,5),c=new ea({name:"CubemapFromEquirect",uniforms:eo(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:Wn,blending:Ra});c.uniforms.tEquirect.value=i;const f=new Un(l,c),d=i.minFilter;return i.minFilter===Yr&&(i.minFilter=Bn),new ET(1,10,this).update(e,f),i.minFilter=d,f.geometry.dispose(),f.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let f=0;f<6;f++)e.setRenderTarget(this,f),e.clear(i,s,l);e.setRenderTarget(c)}}function xw(r){let e=new WeakMap,i=new WeakMap,s=null;function l(v,S=!1){return v==null?null:S?f(v):c(v)}function c(v){if(v&&v.isTexture){const S=v.mapping;if(S===qh||S===Yh)if(e.has(v)){const b=e.get(v).texture;return d(b,v.mapping)}else{const b=v.image;if(b&&b.height>0){const w=new tS(b.height);return w.fromEquirectangularTexture(r,v),e.set(v,w),v.addEventListener("dispose",p),d(w.texture,v.mapping)}else return null}}return v}function f(v){if(v&&v.isTexture){const S=v.mapping,b=S===qh||S===Yh,w=S===Kr||S===Js;if(b||w){let M=i.get(v);const x=M!==void 0?M.texture.pmremVersion:0;if(v.isRenderTargetTexture&&v.pmremVersion!==x)return s===null&&(s=new Uv(r)),M=b?s.fromEquirectangular(v,M):s.fromCubemap(v,M),M.texture.pmremVersion=v.pmremVersion,i.set(v,M),M.texture;if(M!==void 0)return M.texture;{const D=v.image;return b&&D&&D.height>0||w&&D&&m(D)?(s===null&&(s=new Uv(r)),M=b?s.fromEquirectangular(v):s.fromCubemap(v),M.texture.pmremVersion=v.pmremVersion,i.set(v,M),v.addEventListener("dispose",_),M.texture):null}}}return v}function d(v,S){return S===qh?v.mapping=Kr:S===Yh&&(v.mapping=Js),v}function m(v){let S=0;const b=6;for(let w=0;w<b;w++)v[w]!==void 0&&S++;return S===b}function p(v){const S=v.target;S.removeEventListener("dispose",p);const b=e.get(S);b!==void 0&&(e.delete(S),b.dispose())}function _(v){const S=v.target;S.removeEventListener("dispose",_);const b=i.get(S);b!==void 0&&(i.delete(S),b.dispose())}function g(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:g}}function Sw(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&js("WebGLRenderer: "+s+" extension not supported."),l}}}function yw(r,e,i,s){const l={},c=new WeakMap;function f(g){const v=g.target;v.index!==null&&e.remove(v.index);for(const b in v.attributes)e.remove(v.attributes[b]);v.removeEventListener("dispose",f),delete l[v.id];const S=c.get(v);S&&(e.remove(S),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function d(g,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function m(g){const v=g.attributes;for(const S in v)e.update(v[S],r.ARRAY_BUFFER)}function p(g){const v=[],S=g.index,b=g.attributes.position;let w=0;if(b===void 0)return;if(S!==null){const D=S.array;w=S.version;for(let P=0,C=D.length;P<C;P+=3){const I=D[P+0],N=D[P+1],z=D[P+2];v.push(I,N,N,z,z,I)}}else{const D=b.array;w=b.version;for(let P=0,C=D.length/3-1;P<C;P+=3){const I=P+0,N=P+1,z=P+2;v.push(I,N,N,z,z,I)}}const M=new(b.count>=65535?Wx:Xx)(v,1);M.version=w;const x=c.get(g);x&&e.remove(x),c.set(g,M)}function _(g){const v=c.get(g);if(v){const S=g.index;S!==null&&v.version<S.version&&p(g)}else p(g);return c.get(g)}return{get:d,update:m,getWireframeAttribute:_}}function Mw(r,e,i){let s;function l(g){s=g}let c,f;function d(g){c=g.type,f=g.bytesPerElement}function m(g,v){r.drawElements(s,v,c,g*f),i.update(v,s,1)}function p(g,v,S){S!==0&&(r.drawElementsInstanced(s,v,c,g*f,S),i.update(v,s,S))}function _(g,v,S){if(S===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,v,0,c,g,0,S);let w=0;for(let M=0;M<S;M++)w+=v[M];i.update(w,s,1)}this.setMode=l,this.setIndex=d,this.render=m,this.renderInstances=p,this.renderMultiDraw=_}function Ew(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,d){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:Tt("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function bw(r,e,i){const s=new WeakMap,l=new en;function c(f,d,m){const p=f.morphTargetInfluences,_=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,g=_!==void 0?_.length:0;let v=s.get(d);if(v===void 0||v.count!==g){let W=function(){T.dispose(),s.delete(d),d.removeEventListener("dispose",W)};var S=W;v!==void 0&&v.texture.dispose();const b=d.morphAttributes.position!==void 0,w=d.morphAttributes.normal!==void 0,M=d.morphAttributes.color!==void 0,x=d.morphAttributes.position||[],D=d.morphAttributes.normal||[],P=d.morphAttributes.color||[];let C=0;b===!0&&(C=1),w===!0&&(C=2),M===!0&&(C=3);let I=d.attributes.position.count*C,N=1;I>e.maxTextureSize&&(N=Math.ceil(I/e.maxTextureSize),I=e.maxTextureSize);const z=new Float32Array(I*N*4*g),T=new Gx(z,I,N,g);T.type=Zi,T.needsUpdate=!0;const O=C*4;for(let V=0;V<g;V++){const J=x[V],me=D[V],ve=P[V],$=I*N*4*V;for(let B=0;B<J.count;B++){const H=B*O;b===!0&&(l.fromBufferAttribute(J,B),z[$+H+0]=l.x,z[$+H+1]=l.y,z[$+H+2]=l.z,z[$+H+3]=0),w===!0&&(l.fromBufferAttribute(me,B),z[$+H+4]=l.x,z[$+H+5]=l.y,z[$+H+6]=l.z,z[$+H+7]=0),M===!0&&(l.fromBufferAttribute(ve,B),z[$+H+8]=l.x,z[$+H+9]=l.y,z[$+H+10]=l.z,z[$+H+11]=ve.itemSize===4?l.w:1)}}v={count:g,texture:T,size:new mt(I,N)},s.set(d,v),d.addEventListener("dispose",W)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let b=0;for(let M=0;M<p.length;M++)b+=p[M];const w=d.morphTargetsRelative?1:1-b;m.getUniforms().setValue(r,"morphTargetBaseInfluence",w),m.getUniforms().setValue(r,"morphTargetInfluences",p)}m.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function Tw(r,e,i,s,l){let c=new WeakMap;function f(p){const _=l.render.frame,g=p.geometry,v=e.get(p,g);if(c.get(v)!==_&&(e.update(v),c.set(v,_)),p.isInstancedMesh&&(p.hasEventListener("dispose",m)===!1&&p.addEventListener("dispose",m),c.get(p)!==_&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),c.set(p,_))),p.isSkinnedMesh){const S=p.skeleton;c.get(S)!==_&&(S.update(),c.set(S,_))}return v}function d(){c=new WeakMap}function m(p){const _=p.target;_.removeEventListener("dispose",m),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:f,dispose:d}}const Aw={[Tx]:"LINEAR_TONE_MAPPING",[Ax]:"REINHARD_TONE_MAPPING",[Rx]:"CINEON_TONE_MAPPING",[wx]:"ACES_FILMIC_TONE_MAPPING",[Dx]:"AGX_TONE_MAPPING",[Ux]:"NEUTRAL_TONE_MAPPING",[Cx]:"CUSTOM_TONE_MAPPING"};function Rw(r,e,i,s,l,c){const f=new Qi(e,i,{type:r,depthBuffer:l,stencilBuffer:c,samples:s?4:0,depthTexture:l?new $s(e,i):void 0}),d=new Qi(e,i,{type:Da,depthBuffer:!1,stencilBuffer:!1}),m=new qn;m.setAttribute("position",new Hn([-1,3,0,-1,-1,0,3,-1,0],3)),m.setAttribute("uv",new Hn([0,2,0,0,2,0],2));const p=new uT({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),_=new Un(m,p),g=new Hp(-1,1,1,-1,0,1);let v=null,S=null,b=!1,w,M=null,x=[],D=!1;this.setSize=function(P,C){f.setSize(P,C),d.setSize(P,C);for(let I=0;I<x.length;I++){const N=x[I];N.setSize&&N.setSize(P,C)}},this.setEffects=function(P){x=P,D=x.length>0&&x[0].isRenderPass===!0;const C=f.width,I=f.height;for(let N=0;N<x.length;N++){const z=x[N];z.setSize&&z.setSize(C,I)}},this.begin=function(P,C){if(b||P.toneMapping===Ki&&x.length===0)return!1;if(M=C,C!==null){const I=C.width,N=C.height;(f.width!==I||f.height!==N)&&this.setSize(I,N)}return D===!1&&P.setRenderTarget(f),w=P.toneMapping,P.toneMapping=Ki,!0},this.hasRenderPass=function(){return D},this.end=function(P,C){P.toneMapping=w,b=!0;let I=f,N=d;for(let z=0;z<x.length;z++){const T=x[z];if(T.enabled!==!1&&(T.render(P,N,I,C),T.needsSwap!==!1)){const O=I;I=N,N=O}}if(v!==P.outputColorSpace||S!==P.toneMapping){v=P.outputColorSpace,S=P.toneMapping,p.defines={},bt.getTransfer(v)===Ft&&(p.defines.SRGB_TRANSFER="");const z=Aw[S];z&&(p.defines[z]=""),p.needsUpdate=!0}p.uniforms.tDiffuse.value=I.texture,P.setRenderTarget(M),P.render(_,g),M=null,b=!1},this.isCompositing=function(){return b},this.dispose=function(){f.depthTexture&&f.depthTexture.dispose(),f.dispose(),d.dispose(),m.dispose(),p.dispose()}}const nS=new Fn,_p=new $s(1,1),iS=new Gx,aS=new O1,rS=new Zx,Pv=[],Iv=[],zv=new Float32Array(16),Bv=new Float32Array(9),Fv=new Float32Array(4);function so(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=Pv[l];if(c===void 0&&(c=new Float32Array(l),Pv[l]=c),e!==0){s.toArray(c,0);for(let f=1,d=0;f!==e;++f)d+=i,r[f].toArray(c,d)}return c}function yn(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function Mn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function Lu(r,e){let i=Iv[e];i===void 0&&(i=new Int32Array(e),Iv[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function ww(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function Cw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(yn(i,e))return;r.uniform2fv(this.addr,e),Mn(i,e)}}function Dw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(yn(i,e))return;r.uniform3fv(this.addr,e),Mn(i,e)}}function Uw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(yn(i,e))return;r.uniform4fv(this.addr,e),Mn(i,e)}}function Lw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(yn(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),Mn(i,e)}else{if(yn(i,s))return;Fv.set(s),r.uniformMatrix2fv(this.addr,!1,Fv),Mn(i,s)}}function Nw(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(yn(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),Mn(i,e)}else{if(yn(i,s))return;Bv.set(s),r.uniformMatrix3fv(this.addr,!1,Bv),Mn(i,s)}}function Ow(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(yn(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),Mn(i,e)}else{if(yn(i,s))return;zv.set(s),r.uniformMatrix4fv(this.addr,!1,zv),Mn(i,s)}}function Pw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function Iw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(yn(i,e))return;r.uniform2iv(this.addr,e),Mn(i,e)}}function zw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(yn(i,e))return;r.uniform3iv(this.addr,e),Mn(i,e)}}function Bw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(yn(i,e))return;r.uniform4iv(this.addr,e),Mn(i,e)}}function Fw(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function Hw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(yn(i,e))return;r.uniform2uiv(this.addr,e),Mn(i,e)}}function Gw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(yn(i,e))return;r.uniform3uiv(this.addr,e),Mn(i,e)}}function Vw(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(yn(i,e))return;r.uniform4uiv(this.addr,e),Mn(i,e)}}function kw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(_p.compareFunction=i.isReversedDepthBuffer()?Np:Lp,c=_p):c=nS,i.setTexture2D(e||c,l)}function Xw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||aS,l)}function Ww(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||rS,l)}function qw(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||iS,l)}function Yw(r){switch(r){case 5126:return ww;case 35664:return Cw;case 35665:return Dw;case 35666:return Uw;case 35674:return Lw;case 35675:return Nw;case 35676:return Ow;case 5124:case 35670:return Pw;case 35667:case 35671:return Iw;case 35668:case 35672:return zw;case 35669:case 35673:return Bw;case 5125:return Fw;case 36294:return Hw;case 36295:return Gw;case 36296:return Vw;case 35678:case 36198:case 36298:case 36306:case 35682:return kw;case 35679:case 36299:case 36307:return Xw;case 35680:case 36300:case 36308:case 36293:return Ww;case 36289:case 36303:case 36311:case 36292:return qw}}function Zw(r,e){r.uniform1fv(this.addr,e)}function jw(r,e){const i=so(e,this.size,2);r.uniform2fv(this.addr,i)}function Kw(r,e){const i=so(e,this.size,3);r.uniform3fv(this.addr,i)}function Qw(r,e){const i=so(e,this.size,4);r.uniform4fv(this.addr,i)}function Jw(r,e){const i=so(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function $w(r,e){const i=so(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function e2(r,e){const i=so(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function t2(r,e){r.uniform1iv(this.addr,e)}function n2(r,e){r.uniform2iv(this.addr,e)}function i2(r,e){r.uniform3iv(this.addr,e)}function a2(r,e){r.uniform4iv(this.addr,e)}function r2(r,e){r.uniform1uiv(this.addr,e)}function s2(r,e){r.uniform2uiv(this.addr,e)}function o2(r,e){r.uniform3uiv(this.addr,e)}function l2(r,e){r.uniform4uiv(this.addr,e)}function c2(r,e,i){const s=this.cache,l=e.length,c=Lu(i,l);yn(s,c)||(r.uniform1iv(this.addr,c),Mn(s,c));let f;this.type===r.SAMPLER_2D_SHADOW?f=_p:f=nS;for(let d=0;d!==l;++d)i.setTexture2D(e[d]||f,c[d])}function u2(r,e,i){const s=this.cache,l=e.length,c=Lu(i,l);yn(s,c)||(r.uniform1iv(this.addr,c),Mn(s,c));for(let f=0;f!==l;++f)i.setTexture3D(e[f]||aS,c[f])}function f2(r,e,i){const s=this.cache,l=e.length,c=Lu(i,l);yn(s,c)||(r.uniform1iv(this.addr,c),Mn(s,c));for(let f=0;f!==l;++f)i.setTextureCube(e[f]||rS,c[f])}function h2(r,e,i){const s=this.cache,l=e.length,c=Lu(i,l);yn(s,c)||(r.uniform1iv(this.addr,c),Mn(s,c));for(let f=0;f!==l;++f)i.setTexture2DArray(e[f]||iS,c[f])}function d2(r){switch(r){case 5126:return Zw;case 35664:return jw;case 35665:return Kw;case 35666:return Qw;case 35674:return Jw;case 35675:return $w;case 35676:return e2;case 5124:case 35670:return t2;case 35667:case 35671:return n2;case 35668:case 35672:return i2;case 35669:case 35673:return a2;case 5125:return r2;case 36294:return s2;case 36295:return o2;case 36296:return l2;case 35678:case 36198:case 36298:case 36306:case 35682:return c2;case 35679:case 36299:case 36307:return u2;case 35680:case 36300:case 36308:case 36293:return f2;case 36289:case 36303:case 36311:case 36292:return h2}}class p2{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=Yw(i.type)}}class m2{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=d2(i.type)}}class g2{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,f=l.length;c!==f;++c){const d=l[c];d.setValue(e,i[d.id],s)}}}const Td=/(\w+)(\])?(\[|\.)?/g;function Hv(r,e){r.seq.push(e),r.map[e.id]=e}function _2(r,e,i){const s=r.name,l=s.length;for(Td.lastIndex=0;;){const c=Td.exec(s),f=Td.lastIndex;let d=c[1];const m=c[2]==="]",p=c[3];if(m&&(d=d|0),p===void 0||p==="["&&f+2===l){Hv(i,p===void 0?new p2(d,r,e):new m2(d,r,e));break}else{let g=i.map[d];g===void 0&&(g=new g2(d),Hv(i,g)),i=g}}}class gu{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let f=0;f<s;++f){const d=e.getActiveUniform(i,f),m=e.getUniformLocation(i,d.name);_2(d,m,this)}const l=[],c=[];for(const f of this.seq)f.type===e.SAMPLER_2D_SHADOW||f.type===e.SAMPLER_CUBE_SHADOW||f.type===e.SAMPLER_2D_ARRAY_SHADOW?l.push(f):c.push(f);l.length>0&&(this.seq=l.concat(c))}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,f=i.length;c!==f;++c){const d=i[c],m=s[d.id];m.needsUpdate!==!1&&d.setValue(e,m.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const f=e[l];f.id in i&&s.push(f)}return s}}function Gv(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const v2=37297;let x2=0;function S2(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let f=l;f<c;f++){const d=f+1;s.push(`${d===e?">":" "} ${d}: ${i[f]}`)}return s.join(`
`)}const Vv=new st;function y2(r){bt._getMatrix(Vv,bt.workingColorSpace,r);const e=`mat3( ${Vv.elements.map(i=>i.toFixed(4))} )`;switch(bt.getTransfer(r)){case yu:return[e,"LinearTransferOETF"];case Ft:return[e,"sRGBTransferOETF"];default:return it("WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function kv(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),c=(r.getShaderInfoLog(e)||"").trim();if(s&&c==="")return"";const f=/ERROR: 0:(\d+)/.exec(c);if(f){const d=parseInt(f[1]);return i.toUpperCase()+`

`+c+`

`+S2(r.getShaderSource(e),d)}else return c}function M2(r,e){const i=y2(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}const E2={[Tx]:"Linear",[Ax]:"Reinhard",[Rx]:"Cineon",[wx]:"ACESFilmic",[Dx]:"AgX",[Ux]:"Neutral",[Cx]:"Custom"};function b2(r,e){const i=E2[e];return i===void 0?(it("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+r+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const lu=new Q;function T2(){bt.getLuminanceCoefficients(lu);const r=lu.x.toFixed(4),e=lu.y.toFixed(4),i=lu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function A2(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(cl).join(`
`)}function R2(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function w2(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),f=c.name;let d=1;c.type===r.FLOAT_MAT2&&(d=2),c.type===r.FLOAT_MAT3&&(d=3),c.type===r.FLOAT_MAT4&&(d=4),i[f]={type:c.type,location:r.getAttribLocation(e,f),locationSize:d}}return i}function cl(r){return r!==""}function Xv(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Wv(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const C2=/^[ \t]*#include +<([\w\d./]+)>/gm;function vp(r){return r.replace(C2,U2)}const D2=new Map;function U2(r,e){let i=ht[e];if(i===void 0){const s=D2.get(e);if(s!==void 0)i=ht[s],it('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("THREE.WebGLProgram: Can not resolve #include <"+e+">")}return vp(i)}const L2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function qv(r){return r.replace(L2,N2)}function N2(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function Yv(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}const O2={[fu]:"SHADOWMAP_TYPE_PCF",[ll]:"SHADOWMAP_TYPE_VSM"};function P2(r){return O2[r.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const I2={[Kr]:"ENVMAP_TYPE_CUBE",[Js]:"ENVMAP_TYPE_CUBE",[Cu]:"ENVMAP_TYPE_CUBE_UV"};function z2(r){return r.envMap===!1?"ENVMAP_TYPE_CUBE":I2[r.envMapMode]||"ENVMAP_TYPE_CUBE"}const B2={[Js]:"ENVMAP_MODE_REFRACTION"};function F2(r){return r.envMap===!1?"ENVMAP_MODE_REFLECTION":B2[r.envMapMode]||"ENVMAP_MODE_REFLECTION"}const H2={[wu]:"ENVMAP_BLENDING_MULTIPLY",[Jb]:"ENVMAP_BLENDING_MIX",[$b]:"ENVMAP_BLENDING_ADD"};function G2(r){return r.envMap===!1?"ENVMAP_BLENDING_NONE":H2[r.combine]||"ENVMAP_BLENDING_NONE"}function V2(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:s,maxMip:i}}function k2(r,e,i,s){const l=r.getContext(),c=i.defines;let f=i.vertexShader,d=i.fragmentShader;const m=P2(i),p=z2(i),_=F2(i),g=G2(i),v=V2(i),S=A2(i),b=R2(c),w=l.createProgram();let M,x,D=i.glslVersion?"#version "+i.glslVersion+`
